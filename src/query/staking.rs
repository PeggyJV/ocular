...
impl QueryClient {
    ...
    pub async fn validator(&mut self, validator_address: &str) -> Result<staking::QueryValidatorResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
        let request = staking::QueryValidatorRequest { validator_addr: validator_address.to_string() };
    ...
    pub async fn validators(&mut self, status: &str, pagination: Option<PageRequest>) -> Result<staking::QueryValidatorsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn validator_delegations(&mut self, validator_address: &str, pagination: Option<PageRequest>) -> Result<staking::QueryValidatorDelegationsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn validator_unbonding_delegations(&mut self, validator_address: &str, pagination: Option<PageRequest>) -> Result<staking::QueryValidatorUnbondingDelegationsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn delegation(&mut self, delegator_address: &str, validator_address: &str) -> Result<staking::QueryDelegationResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn unbonding_delegation(&mut self, delegator_address: &str, validator_address: &str) -> Result<staking::QueryUnbondingDelegationResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn delegator_delegations(&mut self, delegator_address: &str, pagination: Option<PageRequest>) -> Result<staking::QueryDelegatorDelegationsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn delegator_unbonding_delegations(&mut self, delegator_address: &str, pagination: Option<PageRequest>) -> Result<staking::QueryDelegatorUnbondingDelegationsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn redelegations(&mut self, delegator_address: &str, src_validator_address: &str, dst_validator_address: &str,  pagination: Option<PageRequest>) -> Result<staking::QueryRedelegationsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn delegator_validator(&mut self, delegator_address: &str, validator_address: &str) -> Result<staking::QueryDelegatorValidatorResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn delegator_validators(&mut self, delegator_address: &str, pagination: Option<PageRequest>) -> Result<staking::QueryDelegatorValidatorsResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
    ...
    pub async fn historical_info(&mut self, height: u64) -> Result<staking::QueryHistoricalInfoResponse> {
        let query_client = self.get_grpc_query_client::<StakingQueryClient>().await?;
